...
/**
 * Comprehensive test script for unfugit_ignores MCP tool
...
class UnfugitIgnoresTest {
  ...
  async runComprehensiveTests() {
    ...
    try {
      ...
      // Test 3: Add complex patterns
      this.log('### Test 3: Add Complex Ignore Patterns', colors.cyan);
      ...
      // Test 4: List patterns after additions
      this.log('### Test 4: List All Patterns After Additions', colors.cyan);
      ...
      // Test 5: Add multiple patterns at once
      this.log('### Test 5: Add Multiple Patterns at Once', colors.cyan);
      ...
      const specialPatterns = ['*.test[0-9]', 'data-*.json', 'file (copy).txt', 'path with spaces/', 'file.ext~'];
      ...
      // Test 7: Remove specific patterns
      this.log('### Test 7: Remove Specific Patterns', colors.cyan);
      ...
      // Test 8: List patterns after removals
      this.log('### Test 8: List Patterns After Removals', colors.cyan);
      ...
      // Test 9: Test invalid patterns
      this.log('### Test 9: Test Invalid Patterns', colors.cyan);
      const invalidPatterns = ['', '   ', '\\invalid\\path', '[unclosed bracket'];
      ...
      this.log('### Test 10: Test Invalid Action', colors.cyan);
      try {
        const invalidResult = await this.callTool('unfugit_ignores', { 
          mode: 'invalid_action', 
          patterns: ['*.test'] 
        });
        this.log('**Command:** Invalid action');
        this.log('**Result:**');
        this.printContent(invalidResult);
        this.log('');
      } catch (error) {
        this.log(`**Expected error for invalid action:** ${error.message}`, colors.yellow);
        this.log('');
      }

      // Test 11: Create test files to verify ignore functionality
      this.log('### Test 11: Create Test Files to Verify Ignore Functionality', colors.cyan);
      await this.createTestFiles();
      
      // Final list
      this.log('### Final Test: List All Current Patterns', colors.cyan);
